...
if(isset($_POST["chatGptText"])){
  ...
  $prompt = CHATGPTTOO()->helpers->get_blog_prompt( $_POST["chatGptText"], $_POST["blogNicheText"], $_POST["blogProblemText"], $_POST["blogActionText"], $_POST["blogToneText"], $_POST["blogKeywordText"]);
  $postTitle = $_POST['chatGptText'];   //adding prompt to Blog Title field
  //console_log($prompt);
