...
if(isset($_POST["chatGptText"])){
  ...
  $prompt = AICONTENTT()->helpers->get_prepositions_prompt( $_POST["chatGptText"], intVal($_POST["questionPromtValue"]));
  console_log($prompt);
...
<div class="container-fluid w-50 m-3 bg-light border border-3 shadow p-3 rounded-4"> 
  <h1 class="mt-3 mb-3">Prepositions Keyword Tool</h1>
