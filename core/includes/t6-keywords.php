...
<div class="container-fluid w-50 m-3 bg-light border border-3 shadow p-3 rounded-4"> 
  ...
  <form method="post" id="blogPostForm"  class="needs-validation" novalidate>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom01" name="chatGptText" placeholder="Popular Diets" rows="3" min="0" max="80" value="<?php echo isset($_POST['blogKeywordText']) ? $_POST['blogKeywordText'] : '' ?>" required>
