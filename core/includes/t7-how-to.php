...
if(isset($_POST["chatGptText"])){
  ...
  $prompt = AICONTENTT()->helpers->get_how_to_prompt( $_POST["chatGptText"], $_POST["blogToneText"]);
  //console_log($prompt);
...
<div class="container-fluid w-50 m-3 bg-light border border-3 shadow p-3 rounded-4"> 
  <h1 class="mt-3 mb-3">Create A How To Blog Post</h1>
  <form method="post" id="blogPostForm" class="needs-validation" novalidate>
    ...
    <!-- <div class="mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" name="blogNicheText" placeholder="Affiliate Marketing" rows="3" min="0" max="80" value="<?php echo isset($_POST['blogNicheText']) ? $_POST['blogNicheText'] : '' ?>" required>
      <div class="invalid-feedback">
